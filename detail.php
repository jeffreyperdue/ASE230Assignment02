...
$team = [
	...
	[
        ...
        'role' => 'Team Member 3',
		'job' => 'Superman',
		'email' => 'millern@mymail.nku.edu',0
		'phone' => '555-5555',
	],
				    ...
				    <div class="col">
					    <div class="row p-4 justify-content-center justify-content-md-between">
						    <div class="primary-info col-auto">
							    <h1 class="name mt-0 mb-1 text-white text-uppercase text-uppercase"><?=$team[$i]['firstname'].' '.$team[$i]['lastname']?></h1>
